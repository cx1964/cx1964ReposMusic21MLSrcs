...
# Tbv Ubuntu
curl -u 'cx1964@gmail.com' https://api.github.com/user/repos -d '{"name":"cx1964ReposMusic21MLSrcs"}'

# tbv mingw64 onder windows
# letop vul voor <PASSWORD> een password waarde in
#curl -d '{"name":"cx1964ReposMusic21MLSrcs"}' -u cx1964@gmail.com:<PASSWORD> https://api.github.com/user/repos
...
git add *.md
git add *.sh
git add ./input_files/*.musicxml
git add ./input_files/*.mscz
git add *.py
...
git remote add origin https://github.com/cx1964/cx1964ReposMusic21MLSrcs.git
